            ...
            <div class="error alert alert-success alert-dismissable">
              ...
              {!! session('success') !!}
               ...
               @endif
                  ...
                  <form method="POST" action="{{ route('addnewPackagePost') }}" enctype="multipart/form-data">
                        @csrf
                    <div class="form-group row">
                       <div class="col-md-6">
                           <label for="title" class="col-form-label">{{ __('Select seller or Gym ') }}</label>
                       ...
                       <div class="col-md-6">
                           <label for="admin_comission" class=" col-form-label text-md-right">{{ __('Admin Comission (%)') }}</label>
                           <input class="form-control{{ $errors->has('admin_comission') ? ' is-invalid' : '' }}" type="text" name="admin_comission" value="{{ old('admin_comission') }}" required autofocus>
