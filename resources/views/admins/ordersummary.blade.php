                    ...
                    <div class="card-body pl-0">
                        ...
                        <table class="table table-borderless p-0">
                            <tr>
                                ...
                                <td><strong class="d-block mb-2">Date Added:</strong> <span>{{ Carbon\Carbon::parse($orderdetail[0]->created_at)->format('Y-m-d') }}</span></td>
                            ...
                            <table class="table table-bordered">
                               ...
                               <tr>
                                ...
                                <tr>
                                    ...
                                    <td class=" alert-warning border-0 price text-right"><h4>{{$orderdetail[0]->net_payment}} INR</h4></td>
