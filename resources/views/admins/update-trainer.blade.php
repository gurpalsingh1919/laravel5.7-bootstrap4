            ...
            <div class="col-sm-12 grid-margin stretch-card">
              <div class="card card-statistics">
                <div class="card-header">
                  <b>{{__('Update Trainer')}}</b>
                   @if($trainer_info[0]->status !=1)
                  <div class="float-right">
                        <input type="button"class="btn btn-primary status"  onclick="approvetrainer('1','{{$trainer_info[0]->id}}')" value="Approve" />
                  </div>
                  @endif
                   @if($errors->all())
            ...
            <div class="error alert alert-success alert-dismissable">
              ...
              {!! session('success') !!}
               ...
               @endif
                ...
                <form method="POST" action="{{ route('updateTrainerPost',$trainer_id) }}" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                   <div class="form-group row">
                       <div class="col-md-6">
                           ...
                           <input class="form-control" type="text" name="trainer_name" value="{{$trainer_info[0]->gym_name}}" required autofocus>
                        ...
                        <!-- <div class="col-md-6">
                           ...
                           <input class="form-control" type="email" name="trainer_email" value="{{$trainer_info[0]->user->email}}" required autofocus>
                        ...
                        <div class="col-md-6">
                           ...
                           <input class="form-control" type="text" name="trainer_address" value="{{$trainer_info[0]->gym_address}}" required autofocus>
                        ...
                        <div class="col-md-6">
                           ...
                           <input class="form-control" type="text" name="trainer_zip" value="{{$trainer_info[0]->zip}}" required autofocus>
                        ...
                        <div class="col-md-6">
                           ...
                           <input class="form-control" type="number" name="trainer_tel" value="{{$trainer_info[0]->user->phone_no}}" required autofocus>
                        ...
                        <div class="col-md-6">
                          ...
                          @foreach($cities as $city)
                           <option value="{{$city->name}}" {{$city->name==$trainer_info[0]->city?'selected':''}}>{{$city->name}}</option>
                           @endforeach
                          </select>
                        ...
                        <div class="col-md-6">
                           ...
                           value="{{$trainer_info[0]->expertise}}" required autofocus>
                       ...
                       <div class="col-md-6">
                           ...
                           <select class="form-control" name="trainer_area_expertize">
                            <option value="Yoga Trainer" {{$trainer_info[0]->type_of_expertise=='Yoga Trainer'?'selected':''}} >Yoga Trainer</option>
                            <option value="Personal Trainer" {{$trainer_info[0]->type_of_expertise=='Personal Trainer'?'selected': ''}} >Personal Trainer</option>
                        </select>
                       ...
                       <div class="col-md-6">
                           ...
                           <input class="form-control" type="text" name="trainer_experince" value="{{$trainer_info[0]->experience}}" required autofocus>
                        ...
                        <option value="1" {{$trainer_info[0]->payment_mode=='1'?'selected': ''}}>Monthly</option>
                            <option value="2" {{$trainer_info[0]->payment_mode=='2'?'selected': ''}}>Hourly</option>
                        </select>
                        ...
                        <option value="1" {{$trainer_info[0]->gender=='1'?'selected': ''}}>Male</option>
                        <option value="2" {{$trainer_info[0]->gender=='2'?'selected': ''}}>Female</option>
