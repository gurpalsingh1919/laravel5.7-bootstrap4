                                ...
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <div style="line-height: 24px">
                                           ...
                                           <p>You are registered as trainer with us. Now you account has been approved. Your login url and login credential Given below. Change your password immediate after login.</p><br/>
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                        ...
                                        <div style="line-height: 16px;">
                                            <a href="{{url('/trainerlogin')}}" style="color: #ffffff; text-decoration: none;">Login Here</a>
                                        </div>
                                    </td>
                                </tr>
