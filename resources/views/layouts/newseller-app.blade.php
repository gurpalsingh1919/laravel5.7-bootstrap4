...
<!-- <link href="{{ asset('fontend/styles/bootstrap.css') }}" rel="stylesheet"> -->
    ...
    <link href="{{ asset('theme/plugins/maps/vector/jvector/jquery-jvectormap-2.0.3.css') }}" rel="stylesheet"
          type="text/css"/>
...
<!-- <link href="{{ asset('theme/assets/css/ui-kit/buttons/creative/creative-icon-buttons.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('theme/assets/css/ui-kit/buttons/creative/creative-gradients.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('theme/assets/css/ui-kit/buttons/creative/creative-fill.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('theme/assets/css/ui-kit/buttons/creative/creative-material.css') }}" rel="stylesheet" type="text/css" /> -->
    <!-- Spinner Buttons -->
<!--  <link href="{{ asset('theme/assets/css/ui-kit/buttons/spinner/spinner.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('theme/assets/css/ui-kit/buttons/spinner/ladda.min.css') }}" rel="stylesheet" type="text/css" /> -->
...
<link href="{{ asset('theme/assets/css/ui-kit/custom-typography.css') }}" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="{{ asset('theme/assets/css/design-css/design.css') }}">
 <!-- <link href="{{ asset('theme/plugins/dropzone/dropzone.min.css') }}" rel="stylesheet" type="text/css" />
...
<header class="tabMobileView header navbar fixed-top d-lg-none">
    <div class="nav-toggle">
      ...
      <a href="{{ route('trainerDashboard') }}" class=""> 
...
<header class="header navbar fixed-top navbar-expand-sm">
    ...
    <div class="row ml-lg-auto">
      <div class="col-xl-12 col-md-12 col-sm-12 col-12">
          <h4 style="color: #FB8019;"><span class="flaticon-idea-bulb"><b>  NEAR GYM SELLER</b></span></h4>
      </div>
    </div>
    ...
    <ul class="navbar-nav flex-row ml-lg-auto">
        ...
        <li class="nav-item dropdown user-profile-dropdown ml-lg-0 mr-lg-2 ml-3 mt-2 order-lg-0 order-1">
            <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="flaticon-user-12"></span>
            </a>
            <div class="dropdown-menu  position-absolute" aria-labelledby="userProfileDropdown">
                <a class="dropdown-item" href="{{route('updateseller')}}">
...
<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    ...
    <!-- <script src="{{ asset('theme/plugins/dropzone/custom-dropzone.js') }}"></script> -->
    ...
    <script src="{{ asset('theme/plugins/date_time_pickers/bootstrap_date_range_picker/moment.min.js') }}"></script>
    <script src="{{ asset('theme/plugins/date_time_pickers/bootstrap_date_range_picker/daterangepicker.js') }}"></script>
