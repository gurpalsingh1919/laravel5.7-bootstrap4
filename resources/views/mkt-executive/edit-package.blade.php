            ...
            <div class="row">
              <div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
                <div class="border-bottom d-flex justify-content-between">
                  <div><h4> <i class="flaticon-package mr-2"></i>Update Package</h4></div>
          ...
          <div class="widget-content widget-content-area">
            <div class="row justify-content-center">
              <div class="col-md-12 col-lg-6 border-right border-left">
                ...
                @endif
               <form method="POST" action="{{ route('salesExe-packages.update',$packagedetail) }}" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                <input type="hidden" name="salesexecutive_id" value="{{$packagedetail->salesexecutive_id}}">
                  <div class="form-row">
                    <div class="col-md-12 mb-4">
                      <label for="validationCustom01"><b>{{ __('Select Seller or Gym') }}</b></label>
                       <select class="form-control" name="seller">
                         @foreach($sellers as $seller)
                         <option value="{{$seller->id}}" @if($seller->id==$packagedetail->seller_id){{'selected'}}@endif>{{$seller->gym_name}}
                         </option>
                         @endforeach
                        </select>
                            ...
                            <tr><?php $time=explode('-', $membership->duration);$mstime='';
                             ...
                             ?>
                              ...
                              <td class=" text-center"> 
                                <i class="close t-icon t-hover-icon flaticon-cancel-12"></i> 
