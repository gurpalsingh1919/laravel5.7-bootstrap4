      ...
      <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
        <div class="statbox widget box box-shadow">
              ...
              <div class="row">
                  <div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
                      <div class="d-flex justify-content-between border-bottom">
                         <div><h4> <i class="flaticon-calendar mr-2"></i>Mark Attendance</h4></div>
                          <div class="pt-3"> <a href="{{ route('assignNutrition') }}" class="btn btn-primary">View Attendance</a></div>
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="form-group mb-4 row">
            <label class="col-md-3 text-right" for="exampleFormControlSelect1">Date  <span style="color: #ff3743">*</span></label>
            <div class="col-md-4">
          ...
          <fieldset class="border p-2">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped mb-4">
                ...
                <tbody>
                <form method="post" action="{{route('markuserattandance')}}" enctype="multipart/form-data">
                  @csrf
                    <input type="hidden" name="package_id" value="{{$package_id}}">
                    <input type="hidden" name="attendance_date" value="{{$_GET['date']}}">
                @foreach($mycustomers as $index=>$mycustomer)
                  @if($mycustomer->orderDetails['gym_id']==$freelancer_id)
                  <tr>
                    <td class="checkbox-column">
                      <div class="custom-control custom-checkbox checkbox-primary">
                        <input type="checkbox" class="custom-control-input todochkbox" id="todo-{{$index+1}}" name="attendance[{{$mycustomer->orderDetails['user_id']}}]">
