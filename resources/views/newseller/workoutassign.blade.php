      ...
      <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
        <div class="statbox widget box box-shadow">
          <div class="widget-header">
            <div class="row">
              <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                 <!-- < h4 class="border-bottom mb-3">Assign</h4> -->
                <div class="border-bottom d-flex justify-content-between">
                <div><h4><i class="flaticon-notes-4 mr-2"></i>Assign Workout</h4></div>
                <div class="pt-3"> <a href="{{ route('getWorkouts') }}" class="btn btn-primary">Workout List</a></div>
              </div>
            </div>
          </div>
          <div class="widget-content widget-content-area">
            ...
            <form method="post" action="{{route('assignWorkoutPost')}}" enctype="multipart/form-data">
             @csrf
              <div class="form-group mb-4 row">
              ...
              <div class="form-group mb-4 row">
                ...
                <label class="col-md-3 mt-4 text-right" for="exampleFormControlSelect1">
