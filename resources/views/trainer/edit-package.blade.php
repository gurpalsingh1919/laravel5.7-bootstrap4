            ...
            <div class="row">
              <div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
                <div class="border-bottom d-flex justify-content-between">
                  ...
                  <div class="pt-3"> <a href="{{ route('trainerpackagesList') }}" class="btn btn-primary">Package List</a></div>
                </div>
              </div>
            </div>
          </div>
          <div class="widget-content widget-content-area">
            <div class="row justify-content-center">
              <div class="col-md-12 col-lg-6 border-right border-left">
                ...
                @endif
               <form method="POST" action="{{ route('trainer-packages.update',$packagedetail) }}" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
