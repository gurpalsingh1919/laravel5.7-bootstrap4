...
<div id="content" class="main-content">
  <div class="container">
    ...
    <form action="{{route('updateProductPost',$product_id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
    @csrf
              ...
              <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12 ">
                  <div class="border-bottom d-flex justify-content-between">
                    ...
                    <div class="pt-3"> <a href="{{ route('getAllProductList') }}" class="btn btn-primary">Product List</a></div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="widget-content widget-content-area">
                  <div class="form-group mb-4">
                    <div class="row">
                      ...
                      <div class="col-md-8">
                          <input class="form-control" name="product_name" value="{{$productDetail->name}}" type="text" autocomplete="off">
                    ...
                    <div class="form-group mb-4">
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <textarea rows="3" cols="5" name="product_description" class="form-control" autocomplete="off">{{$productDetail->description}}</textarea>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <select class="form-control form-custom mb-3" name="product_category">
                            ...
                            <option value="{{$category->id}}" @if($category->id==$productDetail->category){{'Selected'}}@endif >{{$category->title}}</option>
                            @endforeach
                    ...
                    <?php $colors=PackagetoPrice::product_colors(); 
                          ...
                          $newcolor=json_decode($productDetail->colors) ?>
                    <div class="form-group mb-4">
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <select class="selectpicker col-md-8" multiple data-actions-box="true" title="Select Product colors" name="product_color[]">
                           @foreach($colors as $key=>$val)
                            <option value="{{$key}}" @if(in_array($key,$newcolor)){{'Selected'}}@endif>{{$val}}</option>
                           @endforeach
                          </select>
                    ...
                    <div class="form-group mb-4">
                      <div class="row">
                        <label class="col-md-4">Size <span class="astrict-sign">*</span>  :</label><?php $newsizes=json_decode($productDetail->size); ?>
                        <div class="col-md-8">
                          <select  class="selectpicker" multiple data-actions-box="true" name="product_size[]" title="Select Product Sizes">
                            ...
                            <option value="{{$keys}}" @if(in_array($keys,$newsizes)){{'Selected'}}@endif>{{$vals}}</option>
                           @endforeach
                          </select>
                  ...
                  <div class="widget-content widget-content-area">
                    <div class="form-group mb-4">
                      <div class="row">
                          ...
                          <div class="col-md-7">
                              <input class="form-control" name="product_price" type="number" value="{{$productDetail->price}}">
                    ...
                    <div class="form-group mb-4">
                      <div class="row">
                          ...
                          <div class="col-md-7">
                              <input class="form-control" name="discount" type="number" value="{{$productDetail->discount}}">
                    ...
                    <div class="form-group mb-4">
                      <div class="row">
                        ...
                        <div class="col-md-7">
                            <input class="form-control" name="weight" type="text" value="{{$productDetail->weight}}">
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="available_quantity" type="number" value="{{$productDetail->quantity}}">
  ...
  <?php $images=json_decode($productDetail->images);
           ?>
   <input type="hidden" id="p_images" data-images="{{$productDetail->images}}">
</div>
...
$(document).ready(function() {
var images=[];
 images=$("#p_images").data('images');
// var array = images.split(","); 
images.forEach(function(item){
  var path='{{asset("product/")}}';
  $("<span class=\"pip\">" +
                        "<img class=\"imageThumb\" src=\"" + path+"/"+ item+ "\"/>" +
                        "<br/>" +
                        "</span>").appendTo(".thumbnail");
  $(".product-img img").attr('src', path+"/"+ item);
            ...
            for (var i = 0; i < filesLength; i++) {
                ...
                fileReader.onload = (function(e) {
                    ...
                    $(".remove").click(function(){
                        $(this).parent(".pip").remove();
                        //$(".product-img img").attr('src', file.result);
                        /*console.log($(this).next(".pip img").attr("src").val());*/
                    });
                    $('.pip img').click(function () {
                        var imgsrc = $(this).attr('src');
