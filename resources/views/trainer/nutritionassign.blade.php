        ...
        <div class="statbox widget box box-shadow">
          <div class="widget-header">
              <div class="row">
                  <div class=" col-xl-12 col-md-12 col-sm-12 col-12">
                      ...
                      <div class="pt-3"> <a href="{{ route('getAllNutrition') }}" class="btn btn-primary">Nutrition Schedule List</a></div>
                      </div>
                  </div>
              </div>
          ...
          <div class="widget-content widget-content-area">
            ...
            @endif
              ...
              <form method="post" action="{{route('nutritionpost')}}" enctype="multipart/form-data">
             @csrf
             <div class="form-group mb-4 row">
                <label class="col-md-3 text-right" for="exampleFormControlSelect1"><b>Select Member</b>
                <span style="color: #ff3743">*</span></label>
                <div class="col-md-3">
